...
cotacao_euro, data_hora_cotacao = buscar_cotacao_euro()
valor_euro = valor_real / cotacao_euro

print(f"Valor informado em reais: R$ {valor_real:.2f}")
print(f"Cotacao oficial do euro (venda): R$ {cotacao_euro:.4f}")
print(f"Data da cotacao utilizada: {data_hora_cotacao}")
print(f"Valor em euros: EUR {valor_euro:.2f}")
